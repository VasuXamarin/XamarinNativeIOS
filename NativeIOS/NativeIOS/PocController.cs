...
namespace NativeIOS
{
    public partial class PocController : UIViewController
    {
        ...
        public PocController(IntPtr handle) : base(handle)
        {
        }
        #region ViewDidLoad
        public async override void ViewDidLoad()
        {
            ...
            await RefreshAsync();
            AddRefreshControl();
            PocTableView.Add(RefreshControl);
        ...
        private async void LoadDropBoxContent()
        {
            try
            {
                if (CrossConnectivity.Current.IsConnected)
                {
                    ...
                    PocTableView.Source = new PocTableViewSource(Data);
                    PocTableView.ReloadData();
